<?php
    ...
    $obj_conexion = mysqli_connect($cons_equipo,$cons_usuario,$cons_contra,$cons_base_datos);
        ...
        echo '<script language="javascript">alert("Ya existe una factura PAGA con ese numero");window.location.href="../historico.php"</script>';
                ...
                $sql="INSERT INTO facturas VALUES( '$id','$nit','$fecha_emision','$fecha_vence','$concepto','$valor','$fecha_actualizacion','$estado','$rutabase','PENDIENTE','PENDIENTE','PENDIENTE','PENDIENTE')";
